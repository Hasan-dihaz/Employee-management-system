...
public:
	...
	void add_new_employee(){
		...
		if (fout){
			fout <<id<<" " <<first_name << " " << last_name << " " << gender << " " << date_of_birth << " " << date_of_join << " " << blood << " " <<
	...
	void view_all_employees(){
		...
		for (int i = 0;i < temp;i++){
			cout<<"\n\t\t|"<< ptr[i].id << "\t"<< ptr[i].first_name<<"\t" << ptr[i].designation << "\t\t" << ptr[i].date_of_join << "\t\t " << ptr[i].phone << "\t\t" << ptr[i].email <<endl;
		}
	...
	void update_employee_info(){
		...
		cout << "\t\t| Full name:" << ptr[counter].first_name << endl;
		...
		if (check == "Y"){
			...
			if(fout){
				for (int i = 0;i < temp;i++){
					fout << ptr[i].id << " " << ptr[i].first_name << " " << ptr[i].last_name << " " << ptr[i].gender << " " << ptr[i].date_of_birth << " " << ptr[i].date_of_join << " " << ptr[i].blood << " " <<
	...
	void delete_info(){
		...
		cout << "Name:" << ptr[counter].first_name << endl;
		cout << "Designation:" << ptr[counter].designation << endl;
		cout << "Gender:" << ptr[counter].gender << endl;
		cout << "Date of birth:" << ptr[counter].date_of_birth << endl;
		cout << "Date of join:" << ptr[counter].date_of_join << endl;
		...
		if (check =="Y"){
			for (int i = counter;i < temp-1;i++){
				ptr[i].id = ptr[i + 1].id;
				ptr[i].first_name = ptr[i + 1].first_name;
	...
	void search_employee(){
		...
		cout << "Name          : " << ptr[counter].first_name<<" "<< ptr[counter].last_name<<endl;
		cout << "Designation   : " << ptr[counter].designation << endl;
		cout << "Gender        : " << ptr[counter].gender << endl;
		cout << "Date of Birth : " << ptr[counter].date_of_birth << endl;
		cout << "Date of Join  : " << ptr[counter].date_of_join << endl;
...
void menu(){   cout <<"\t==============Main Menu=============="<<endl<<endl<<endl;
